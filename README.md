# yt-marker
A firefox browser extension for saving timestamps for YouTube videos and livestreams.

# Getting started
It is currently only possible to load the addon as a temporary addon as it has not been signed by Firefox. I do not plan to fix this in the near future.

If you still want to use the extension it can be loaded by going through the following steps:
1. Inside Firefox open 'Manage extensions'
...
![image](https://github.com/user-attachments/assets/8b0be0e8-0a09-4015-8ce5-90fcc56faf08)
